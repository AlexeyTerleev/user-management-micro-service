...
class TestUsersService:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            ("wrong_email@email.com", pytest.raises(UsersService.UserNotFoundException)),
        ]
    )
    ...
    @pytest.mark.parametrize(
        ...
        [
            (UserUpdateSchema(name="new_name", username="new_username"), does_not_raise()),
            (UserUpdateSchema(surname="surname"), pytest.raises(UsersService.NothingToUpdateException)),
        ]
    )
    async def test_update_user(self, user, new_values, expectation):
        ...
        with expectation:
            ...
            updated_dict, new_values_dict = updated.model_dump(), new_values.model_dump()
    ...
    async def test_get_users(self, users, page, limit, filter_by_name, filter_by_surname, filter_by_group_id, sorted_by, ordered_by, res):
        service = users_service()
        getted = await service.get_users(page, limit, filter_by_name, filter_by_surname, filter_by_group_id, sorted_by, ordered_by)
